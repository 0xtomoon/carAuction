...
import CarAuctionCarauctionCarauction from './carAuction/carauction.carauction'
...
export default { 
  CarAuctionCarauctionCarauction: load(CarAuctionCarauctionCarauction, 'carauction.carauction'),
